...
import { AiTutorHelp } from "@/components/ai-tutor-help";
import {
...
import type { BasicArithmeticOperation } from "@/lib/arithmetic";
import {
...
function getArithmeticHint(operation: BasicArithmeticOperation): string {
  if (operation === "add") {
    return "Add the two whole numbers together.";
  }

  if (operation === "subtract") {
    return "Subtract the second whole number from the first.";
  }

  if (operation === "multiply") {
    return "Multiply the two whole numbers together.";
  }

  return "Divide the first whole number by the second and check that the result is whole.";
}
...
export default function Home() {
  ...
  function getCustomQuestionHint(question: CustomQuestion): string {
    ...
    if (question.topic === "arithmetic") {
      return getArithmeticHint(question.problem.operation);
    }
  ...
  function checkCustomAnswer() {
    ...
    } else if (customQuestion.topic === "arithmetic") {
      setCustomMessage(`Not yet. ${getArithmeticHint(customQuestion.problem.operation)}`);
    } else {
